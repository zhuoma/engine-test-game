class UserPanel extends engine.DisplayObjectContainer {
    constructor() {
        ...
        this.background.addEventListener(engine.TouchEventsType.CLICK, (e) => {
        ...
        this.weaponIconBitmap.addEventListener(engine.TouchEventsType.CLICK, (e) => {
        ...
        this.helmentIconBitmap.addEventListener(engine.TouchEventsType.CLICK, (e) => {
        ...
        this.corselerIconBitmap.addEventListener(engine.TouchEventsType.CLICK, (e) => {
        ...
        this.shoesIconBitmap.addEventListener(engine.TouchEventsType.CLICK, (e) => {
